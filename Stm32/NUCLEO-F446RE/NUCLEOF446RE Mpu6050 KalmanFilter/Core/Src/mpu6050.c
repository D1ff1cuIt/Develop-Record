...
#define RAD_TO_DEG 57.295779513082320876798154814105 /*弧度轉角度*/
...
const double Accel_Z_corrector = 14418.0 / 8;
const double AxAvg = 0;
const double AyAvg = 0;
const double AzAvg = 0;
const double GxAvg = 0;
const double GyAvg = 0;
const double GzAvg = 0;
